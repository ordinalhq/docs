...
Reviewers see a preview that matches the destination channel's native UI, so you can catch formatting issues before content publishes. Previews are available for:

- **Discord** - server message layout with workspace avatar and name
- **Facebook** - feed posts and Reels
- **Instagram** - feed, Reels, and Stories
- **LinkedIn** - personal and company page posts
- **Slack** - channel message layout
- **Threads** - single posts and multi-post threads
- **TikTok** - vertical video with caption
- **Twitter/X** - single tweets and threads
- **YouTube Shorts** - vertical video with title

Notification emails and Slack messages also include a preview image of the first applicable channel, so reviewers can spot-check at a glance before opening the post.
