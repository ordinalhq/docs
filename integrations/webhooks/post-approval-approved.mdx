...
description: "Webhook event fired when an approver grants approval for an Ordinal post, including the approver, post ID, and remaining approval gates before publish."
