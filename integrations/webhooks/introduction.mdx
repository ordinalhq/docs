---
title: "Ordinal webhooks"
sidebarTitle: "Introduction"
description: "Subscribe to Ordinal webhooks to receive real-time HTTP notifications when posts publish, approvals change, comments are added, or social profiles update."
keywords: ["Ordinal webhooks", "social media webhooks", "post events", "approval webhooks"]
---
