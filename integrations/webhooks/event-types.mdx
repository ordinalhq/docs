...
description: "Reference of every Ordinal webhook event type, payload schema, and example body, including post, comment, approval, invite, and social profile events."
keywords: ["Ordinal webhook events", "post.published event", "social profile webhook events"]
---
