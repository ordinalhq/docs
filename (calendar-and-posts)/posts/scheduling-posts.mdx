...
description: "Set a publish date and time for your post. Use Ordinal's recommended times for each platform or pick a custom slot."
icon: "clock"
---
...
<Accordion>
  <AccordionItem title="Post failed to publish">
  ...
  <AccordionItem title="New cross-post channel not scheduled">
