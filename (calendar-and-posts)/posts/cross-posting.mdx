...
<Accordion>
  <AccordionItem title="Match platform culture">
  ...
  <AccordionItem title="Preview each version">
  ...
  <AccordionItem title="Cross-Posting from profiles within the same channel">
