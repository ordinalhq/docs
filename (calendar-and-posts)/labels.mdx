...
<Accordion>
  <AccordionItem title="Content type">
  ...
  <AccordionItem title="Topic or pillar">
    Organize by subject:
  ...
  <AccordionItem title="Status (internal)">
  ...
  <AccordionItem title="Funnel stage">
