---
title: "Calendar"
description: "Plan your content in calendar or list view. Filter by platform or status, and drag posts to reschedule."
keywords: ["Ordinal calendar", "social media calendar", "content calendar tool", "social media planner"]
icon: "calendar"
---
...
Right-click any post on the calendar to manage it without opening the editor:

| Action                   | What it does                                                          |
| ------------------------ | --------------------------------------------------------------------- |
| **Rename**               | Edit the post title in a dialog. The card updates immediately on save |
| **Change Status**        | Set a new status, or move the post back to Ideas                      |
| **Copy Post Link**       | Copy a shareable link to the post                                     |
| **Duplicate Post**       | Create a copy of the post                                             |
| **Batch Duplicate Post** | Create multiple copies at once                                        |
| **Delete Post**          | Move the post to the trash                                            |

<Note>
  Post titles cannot be empty. If you save a blank title, the rename dialog stays open so you can enter a valid one.
</Note>
