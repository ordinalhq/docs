...
<CardGroup cols={2}>
  ...
  <Card title="Slack Boosts" icon="slack" href="/api-reference/slack-boosts">
    Create, list, get, update, and delete Slack Boosts to notify channels when posts publish
  </Card>
</CardGroup>
