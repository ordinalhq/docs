...
description: "Authenticate Ordinal API requests with a workspace API key sent as a Bearer token in the Authorization header. Includes setup steps and example requests."
keywords: ["Ordinal API authentication", "Ordinal API key", "Bearer token"]
---
