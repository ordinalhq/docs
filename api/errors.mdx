---
title: "Ordinal API error handling and status codes"
sidebarTitle: "Error Handling"
description: "Reference for Ordinal API error responses, including HTTP status codes, error code identifiers, response shape, and how to handle common failure cases."
keywords: ["Ordinal API errors", "API error codes", "Ordinal error handling"]
---
