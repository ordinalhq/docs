---
title: "File Uploads"
description: "Upload images and videos to Ordinal by submitting a public URL via the API, then attach the returned assetId when creating or updating posts programmatically."
