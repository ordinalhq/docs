...
Use the [Mention format by username](/api/linkedin/linkedin-get-mention) endpoint to look up URNs by LinkedIn username.
...
If you already have a URN and need to resolve it to a username, name, or profile picture, use the [Get LinkedIn profile by URN](/api/linkedin/linkedin-get-profile) endpoint.
...
Mentions also work in team engagement comments and reposts:
