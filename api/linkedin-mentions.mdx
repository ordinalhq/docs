...
If you already have a URN and need to resolve it to a username, name, or profile picture, use the [Get LinkedIn profile by URN](/api-reference/linkedin/linkedin-get-profile) endpoint.
