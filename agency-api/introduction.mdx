...
description: "Programmatically manage multiple client workspaces from one set of company API keys. Create workspaces, invite users, and automate posting at agency scale."
keywords: ["Ordinal Agency API", "agency social media API", "multi-workspace API"]
---
