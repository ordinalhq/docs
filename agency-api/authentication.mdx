---
title: "Agency API authentication with company keys"
sidebarTitle: "Authentication"
description: "Authenticate Ordinal Agency API requests using company-level API keys to manage multiple client workspaces from a single set of credentials."
keywords: ["Ordinal Agency API authentication", "company API key"]
---
