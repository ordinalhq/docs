...
You can create campaigns from multiple places:

- **Campaigns page** — Click **New Campaign** in the sidebar
- **Calendar** — Right-click and select **New Campaign** (date range pre-fills)
- **Post sidebar** — Click **Create Campaign** in the Campaign dropdown
...
<Tabs>
  <Tab title="Overview">
    ...
    - **Campaign brief** — A rich text editor for overview, key messaging, goals/KPIs, target audience, and notes. Supports headings, lists, links, and formatting.
