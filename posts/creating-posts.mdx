...
description: "Create new posts in Ordinal from the calendar, the P keyboard shortcut, an existing idea, or by duplicating another post to reuse copy and configuration."
icon: "plus"
---
