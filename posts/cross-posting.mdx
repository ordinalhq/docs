---
title: "Cross-Posting"
description: "Publish a single post to multiple social platforms at once and customize copy, media, and platform-specific settings independently for each channel in Ordinal."
keywords: ["cross-post social media", "multi-platform posting", "Ordinal cross-posting"]
icon: "arrows-repeat"
---
...
Changes you make in one tab only affect that platform - unless content is synced (see [Syncing content](#syncing-content) below).
