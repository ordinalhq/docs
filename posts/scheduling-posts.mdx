...
description: "Set a publish date and time for your post in Ordinal. Use recommended times for each platform, queue auto-scheduled slots, or pick a custom date and time."
keywords: ["schedule social media posts", "Ordinal scheduling", "auto-schedule posts"]
icon: "clock"
---
...
3. The post returns to "Finalized" status
