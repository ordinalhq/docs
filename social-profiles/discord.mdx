...
description: "Schedule announcements to Discord channels using channel webhooks. No Discord login required."
---
...
![Discord Hero](/images/Discord-hero.jpg)
...
<CardGroup cols={2}>
  ...
  <Card title="Drafting a Message" icon="square-pen" href="#drafting-a-discord-message">
