---
title: "Threads"
description: "Schedule Threads posts with text, images, video, or as multi-part threads. Connects through Instagram (Business or Creator account, public profile)."
...
<CardGroup cols={2}>
  ...
  <Card title="Drafting a Post" icon="square-pen" href="#drafting-a-threads-post">
    Formatting, mentions, and media
  </Card>
  <Card title="Multi-part Threads" icon="layers" href="#multi-part-threads">
