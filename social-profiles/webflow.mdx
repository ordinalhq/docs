---
title: "Webflow"
description: "Schedule blog posts and CMS items to a Webflow collection alongside your social posts."
icon: "globe"
---
...
<CardGroup cols={2}>
  ...
  <Card title="Writing Content" icon="square-pen" href="#writing-content">
    Rich text editor and blog formatting
  </Card>
  <Card title="CMS Fields" icon="columns-3" href="#cms-fields">
