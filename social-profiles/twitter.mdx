...
![X Team Engagements](/images/x-auto-eng.jpg)
...
Coordinate likes, replies, and retweets from your team's connected accounts after your tweet publishes to boost initial visibility. Twitter supports these team engagement types:

| Type             | What it does                                                                 |
| ---------------- | ---------------------------------------------------------------------------- |
| **Team Likes**   | Select connected profile(s) like your tweet                                  |
| **Team Repost**  | Retweet from any connected Twitter account                                   |
| **Team Comment** | Add a first reply (great for additional context, links, or a call-to-action) |
