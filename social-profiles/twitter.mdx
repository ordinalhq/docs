...
title: "Twitter / X"
icon: "/icons/x.svg"
description: "Schedule individual tweets, build multi-tweet threads, coordinate team engagements, and track tweet performance."
---

Twitter is one of the fastest platforms for real-time engagement. In Ordinal, you can schedule individual tweets, build multi-tweet threads, and coordinate team engagements - all timed to publish when your audience is most active.
...
<CardGroup cols={2}>
  ...
  <Card title="Drafting a Tweet" icon="square-pen" href="#drafting-a-tweet">
    Formatting, mentions, media, and threads
  </Card>
  <Card title="Team Engagements" icon="thumbs-up" href="#team-engagements">
    Coordinate likes, retweets, and replies from your team
  </Card>
...
There are two types of connections supported for Twitter: **scheduling** and **engagement-only**. Scheduling profiles can post tweets, threads, and use team engagements. Engagement-only profiles are used purely for team engagements (liking, retweeting, replying to posts).
...
| [Threads](#tweet-threads)             | ✅         | Multi-tweet sequences with individual media |
...
<Tabs inline>
  ...
  <Tab title="Videos" id="videos">
    ...
    You don't need to re-encode videos that exceed these specs. Ordinal automatically converts HEVC videos to H.264 and reduces videos above 60 fps to 60 fps before publishing to Twitter.
  </Tab>
  <Tab title="GIFs" id="gifs">
...
![X Team Engagements](/images/x-team-engagements.jpg)

:::note
Team engagements are available for **Pro** plan workspaces and above. Starter workspaces can only add team engagements from the same account as the tweet author.
:::

Make it easy for your team to coordinate likes, replies, and retweets from their connected accounts after your tweet publishes. Twitter supports these team engagement types:

| Type             | What it does                                                                 |
| ---------------- | ---------------------------------------------------------------------------- |
| **Team Likes**   | Make it easy for selected connected profiles to like your tweet              |
| **Team Repost**  | Help a team member retweet from a connected Twitter account                  |
| **Team Comment** | Help a team member add a first reply (great for additional context, links, or a call-to-action) |

Choose a time from **immediately** after posting up to **24 hours** later. Staggering engagements across different delays helps your team coordinate activity.
