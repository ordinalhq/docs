...
**For engagement-only**: Go to [**Settings → Profiles → Engagement**](https://app.tryordinal.com/settings/profiles/engagement/x), select Twitter/X, and sign in.
...
<Tabs>
  <Tab title="Images">
    You can upload one or multiple image(s) per Tweet. Multiple images display in a grid layout. Add alt text for accessibility via the image options.
