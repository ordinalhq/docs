...
Twitter is built for real-time conversation and quick, punchy content. In Ordinal, you can schedule individual tweets, build multi-tweet threads, and coordinate auto-engagements—all timed to publish when your audience is most active.

![Twitter Post Editor](/images/ordinalLinkedIn.jpg)
...
There are two types of connections supported for Twitter: **scheduling** and **engagement-only**. Scheduling profiles can post tweets, threads, and use auto-engagements. Engagement-only profiles are used purely for auto-engagements (liking, retweeting, replying to your own posts).

**For scheduling**: Go to [**Settings → Profiles → Scheduling**](https://app.tryordinal.com/settings/profiles/scheduling/twitter), select Twitter/X, and sign in.

**For engagement-only**: Go to [**Settings → Profiles → Engagement**](https://app.tryordinal.com/settings/profiles/engagement/twitter) and connect separately.

<Tip>
  Twitter tokens rarely expire on their own. You'll only need to reconnect if you change your password or revoke app permissions in Twitter's settings.
</Tip>
...
For a more realistic preview, click the **Feed Preview** button to see your tweet in a full Twitter feed context with:

- Your profile picture and name as they'll appear
- Desktop and mobile view options
- Thread preview for multi-tweet posts
...
<Tip>
  Each tweet in a thread should stand alone while contributing to the whole. The first tweet is especially important—it determines whether people read on.
</Tip>
