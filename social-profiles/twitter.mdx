---
title: "Twitter / X"
description: "Schedule individual tweets, build multi-tweet threads, run auto-engagements from connected accounts, and track tweet performance on Twitter/X with Ordinal."
