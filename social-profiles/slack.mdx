...
title: "Slack"
icon: "slack"
description: "Schedule announcements and updates to Slack channels alongside your other social content."
---
...
![Slack Announcement](/images/slack-announcement.jpg)
...
<CardGroup cols={2}>
  ...
  <Card title="Drafting a Message" icon="square-pen" href="#drafting-a-slack-message">
...
<Accordion>
  <AccordionItem title="Can't connect">
