...
<AccordionGroup>
  <Accordion title="Channel not appearing">
    The Ordinal app must be invited to private channels. Type `/invite @Ordinal` in the channel.
  </Accordion>
  ...
  <Accordion title="Formatting looks wrong">
    Some advanced formatting may render differently depending on Slack client versions.
  </Accordion>
</AccordionGroup>
