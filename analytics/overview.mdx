...
For LinkedIn posts, you can also refresh stats directly from a post:

1. Open a published LinkedIn post
2. In the **Published Post** panel, open the **⋮** menu next to **View Post**
3. Select **Refresh Stats** and confirm

This refreshes stats for every post on that LinkedIn profile or company page - not just the post you opened from - and shares the same once-per-hour cooldown as the account-level refresh.
