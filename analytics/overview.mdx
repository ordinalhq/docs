...
<Note>
  **Saves** and **Sends** are available for personal LinkedIn profiles. Historical posts were backfilled, so you'll see these metrics across your existing analytics as well.
</Note>
