...
For LinkedIn, Instagram, and Facebook posts, you can also refresh stats directly from a post:

1. Open a published LinkedIn, Instagram, or Facebook post
2. In the **Published Post** panel, open the **⋮** menu next to **View Post**
3. Select **Refresh Stats** and confirm

This refreshes stats for every post on that account - not just the post you opened from - and shares the same once-per-hour cooldown as the account-level refresh.

The **Published Post** panel also shows an **Updated X ago** label next to **View Post** so you can see when stats were last synced. Hover the label to see the exact timestamp.
