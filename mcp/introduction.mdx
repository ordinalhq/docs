...
description: "The Ordinal MCP server lets Claude, Cursor, Codex, and other AI assistants draft posts, schedule content, and run workflows inside your Ordinal workspace."
