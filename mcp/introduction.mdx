---
title: "Ordinal MCP server"
description: "The Ordinal MCP server lets Claude, Cursor, Codex, and other AI assistants work inside your Ordinal workspace."
sidebar:
  label: "Introduction"
---
...
<Frame>
  ![Mcp Showcase](/images/mcp-showcase.jpg)
</Frame>

<CardGroup cols={2}>
  <Card title="Posts and ideas" icon="file-text">
  ...
  <Card title="Media uploads" icon="cloud-upload">
    Attach images and videos to posts from a URL.
  </Card>

  <Card title="Team engagements" icon="heart">
    Coordinate likes, comments, and reposts from connected team profiles.
  </Card>
...
<Card title="Migration guide" icon="arrow-left-right" href="/mcp/migrating">
