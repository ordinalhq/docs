...
<Accordion>
  <AccordionItem title="Claude" icon="bot-message-square">
    :::info
  ...
  <AccordionItem title="Claude Code" icon="terminal">
    <Steps>
  ...
  <AccordionItem title="Codex" icon="square-terminal">
    <Steps>
  ...
  <AccordionItem title="Codex CLI" icon="square-terminal">
    <Steps>
  ...
  <AccordionItem title="Cursor" icon="code">
    **One-click install**
  ...
  <AccordionItem title="VS Code" icon="code">
    **One-click install**
  ...
  <AccordionItem title="Other AI tools" icon="ellipsis">
