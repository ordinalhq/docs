---
title: "Ordinal MCP server tools reference"
sidebarTitle: "Tools"
description: "Reference of every tool the Ordinal MCP server exposes for managing posts, ideas, approvals, comments, analytics, media uploads, and Slack boosts."
