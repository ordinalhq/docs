...
| `ordinal_create_post` | Creates a post with LinkedIn, X, Instagram, TikTok, YouTube Shorts, and/or Facebook content. |
...
| `ordinal_search_facebook_pages` | Searches Facebook Pages by name to find a Page ID — useful for mentioning a brand or organization in a post. |
