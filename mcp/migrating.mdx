...
description: "How to migrate from the old API-key Ordinal MCP server to the new OAuth-based server at app.tryordinal.com/mcp."
---
...
<Accordion>
  <AccordionItem title="Tool names have changed">
  ...
  <AccordionItem title="You now pass workspaceSlug explicitly">
  ...
  <AccordionItem title="My assistant still shows the old tools">
