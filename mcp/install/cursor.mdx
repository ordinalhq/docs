...
<a href="cursor://anysphere.cursor-deeplink/mcp/install?name=ordinal&config=eyJ1cmwiOiJodHRwczovL2FwcC50cnlvcmRpbmFsLmNvbS9tY3AifQ==">
  <img className="block dark:hidden" src="https://cursor.com/deeplink/mcp-install-dark.svg" alt="Add Ordinal to Cursor" height="28" />
  <img className="hidden dark:block" src="https://cursor.com/deeplink/mcp-install-light.svg" alt="Add Ordinal to Cursor" height="28" />
</a>

Opens Cursor and installs the Ordinal MCP server. Sign in with your Ordinal account when prompted.
