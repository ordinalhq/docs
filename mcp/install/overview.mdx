---
title: "Install the Ordinal MCP server"
sidebarTitle: "Installation"
description: "Install the Ordinal MCP server in Claude, Claude Code, Codex, Codex CLI, Cursor, or VS Code, then sign in once with OAuth to start using AI assistants."
